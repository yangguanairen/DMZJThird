 ...
 * Time: 19:09
 */
public class ComicRankSubscribeAdapter extends BaseQuickAdapter<ComicSubscribeRankBean, BaseViewHolder> implements LoadMoreModule {

    private final Context mContext;

    public ComicRankSubscribeAdapter(Context context) {
    ...
    @Override
    protected void convert(@NotNull BaseViewHolder holder, ComicSubscribeRankBean bean) {
        Glide.with(mContext)
