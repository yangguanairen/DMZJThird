 ...
 * Time: 17:00
 */
public class ComicFilterAdapter extends BaseQuickAdapter<ComicClassifyFilterBean, BaseViewHolder> {
    ...
    public ComicFilterAdapter(Context context) {
        super(R.layout.item_comic_filter);
    ...
    protected void convert(@NonNull BaseViewHolder holder, ComicClassifyFilterBean bean) {
        ...
        ComicFilterChildAdapter adapter = new ComicFilterChildAdapter();
